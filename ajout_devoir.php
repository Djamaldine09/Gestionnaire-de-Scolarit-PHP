...
$data=mysqli_query($conn,"select distinct nommat from matiere order by nommat");
$donnee=mysqli_query($conn,"select matiere.codemat, matiere.nommat from matiere inner join classe on matiere.codecl = classe.codecl where classe.nom ='$nomcl' and classe.promotion = '$promo'");
?>
<FIELDSET>
